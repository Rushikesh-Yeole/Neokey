...
const Login = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
        ...
        let { data } = await axios.post(backendUrl + '/auth/otp', { cryptemail, cryptpassword });
        if (data.success) {
  ...
  const verifyOtp = async () => {
    if(isSent){try {
      ...
      let { data } = await axios.post(backendUrl + '/auth/verify-account', { cryptemail, cryptpassword, cryptotp, cryptsalt });
      if (data.success) {

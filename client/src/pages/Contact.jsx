    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-cyan-900 font-sans select-none">
      ...
      <header className="text-center py-6 pt-32">
        ...
        <p className="mt-4 text-base text-gray-300">
          We'll fix issues (if any) & respond (mail needed)
        </p>
      </header>
      <main className="flex-grow max-w-md mx-auto px-4 sm:px-6 mb-8">
        <div className="glass-card p-4 sm:p-6 rounded-lg shadow-glass bg-white">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="name" className="block text-base font-medium text-cyan-200 mb-1">
                Name *
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="email" className="block text-base font-medium text-cyan-200 mb-1">
                Your mail for us to respond <span className="text-sm text-gray-400">(optional)</span>
              </label>
              <input
                type="email"
                id="email"
      ...
      <div className="w-full sm:mt-4 pt-2 mt-32 text-slate-400">
        <Footer />
      </div>
    </div>
  );

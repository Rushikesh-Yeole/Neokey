...
const FAQAndHowTo = () => {
  ...
  },    
  {
    ...
    answer: (
      <>
        Neokey <strong>doesn't store your passwords or any sensitive data </strong> thus minimizing attack surfaces. 
        <br></br>
        It uses specific algorithms to generate your passwords only when requested, along with advanced encryption 
        for secure data transmission and MFA to ensure secure access.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        If you lose your Neokey, you can always <strong>reset it</strong>!
        <br></br>Previously generated passwords will remain unaffected, 
        ensuring <strong>backward compatibility</strong>.
      </>
    ),
  },
  {

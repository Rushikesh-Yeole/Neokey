...
const FAQAndHowTo = () => {
  ...
  const faqs = [
  {
    ...
    answer: (
      <>
        Traditional managers are digitized notebooks. If they get hacked, you lose everything.
        <br></br>
        <br></br>Neokey is your ultimate password platform: Stateless, Ultra-secure, and Anonymous. 
        <br></br>It's a password platform that <strong> doesn't store passwords or user identifiers, even encrypted.</strong>
        <br></br>If computes your passwords <strong>in real-time</strong> using high-entropy math. 
        <br></br>
        <br></br>No storage means No leaks.
      </>
    ),
  },    

  {
    ...
    answer: (
      <>
        ...
        <br></br>
        <br></br>
        It uses end-to-end encryption for transit and irreversible multi-step hashing for verification.
        <br></br>
        The database is completely opaque & anoymous.
        <br></br>
        Neokey enforces 2FA for safe, brute-force-resistant access.
        <br></br>
  ...
  {
    question: "Can I update or change my passwords easily?",
    answer: (
      <>
        Absolutely!
        <br/>
        Triggering a 'create' automatically rotates your credentials with a fresh, high-entropy password. 
        <br/>
        Neokey manages this automatically, eliminating manual versioning/rules.
        <br/>
        You could also delete any service password you don't use anymore.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <br></br>
        <br></br>
        Use the <strong>Recovery Artifact file</strong> you downloaded at signup, to regain you master password.
        <br/>
        If you lost that too, we can't help you.
      </>
  ),
  },
  {
    ...
    answer: (
      <>
        ...
        <br/><br/>
        Generate a temporary <strong>6-digit sequence</strong> device and enter it on the target device. Bifrost generates ephemeral RSA-2048 keys on the fly to securely beam your session across, completely blinding the server to your session details.
        <br/><br/>
        The tunnel stays open for exactly <strong>60 seconds</strong> and requires explicit host authorization. Once the jump is complete, the new session remains active for 45 minutes.
        <br/>Get in, get out, leave zero trace.
      </>
    ),
  },    
];
  ...
  return (
    <div className='autocomplete="off" bg-gradient-to-b from-cyan-600 to-cyan-700 animate-pulse-smooth text-gray-900 font-sans min-h-screen select-none'>
      ...
      <main className="max-w-4xl mx-auto px-6 sm:px-12">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-6">How to u  se Neokey</h2>
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="border-b border-black pb-4">
                <button
                  ...
                  className="w-full rounded-md text-left flex justify-between items-center text-xl font-semibold "
                >
                  {faq.question}
                  <span>{selectedQuestion === index ? "-" : "+"}</span>
                </button>
                {selectedQuestion === index && (
                  <p className="text-lg mt-3 text-gray-200">{faq.answer}</p>
                )}
              </div>
            ))}
          </div>

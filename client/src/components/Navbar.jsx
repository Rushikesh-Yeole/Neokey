...
const Navbar = () => {
  ...
  return (
      ...
      <button className="z-10 flex justify-center ml-auto items-center px-4 py-1.5 sm:py-1 sm:mr-3 sm:px-5 mb-2 rounded-full border border-slate-300 bg-gray-800 shadow-lg text-cyan-300 group relative cursor-pointer glass-card">  
        ...
        :
        <button onClick={() => navigate('/login')} className="ml-auto mr-2 sm:mr-4 mb-2 flex items-center sm:text-lg bg-cyan-200 border border-[#00f9ff] rounded-full px-4 py-1 sm:px-4 shadow-xl text-white hover:bg-cyan-200 hover:text-slate-800 glass-card">
          Login
        </button>}
